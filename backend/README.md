...
## Project Structure
    ...
    ├── testapiautoteammemb_94952  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammemb_94952`
...
2. Clone this repo and `cd testapiautoteammemb_94952`
